...
from ..cursors import Cursor, DeserializationCursor, DictCursor, SSCursor, SSDictCursor
...
async def _create_engine(
    ...
    **kwargs
    ...
    pool = await aiomysql.create_pool(
        minsize=minsize, maxsize=maxsize, loop=loop, pool_recycle=pool_recycle, **kwargs
    )
