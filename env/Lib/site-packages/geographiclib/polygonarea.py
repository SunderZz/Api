...
class PolygonArea:
    ...
    def _transit(lon1, lon2):
        ...
        return (
            1
            if lon12 > 0 and (lon1 < 0 <= lon2 or (lon1 > 0 and lon2 == 0))
    ...
    def _transitdirect(lon1, lon2):
        ...
        lon1 = Math.remainder(lon1, 720.0)
        lon2 = Math.remainder(lon2, 720.0)
        return (0 if 0 <= lon2 < 360 else 1) - (0 if 0 <= lon1 < 360 else 1)
