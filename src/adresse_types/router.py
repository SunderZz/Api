...
async def update_adresse_type(adresses_type_id: int, adresse_type: AdresseTypeBase,adresses_type_repository: AdresseTypesRepository = Depends(AdresseTypesRepository), db: Session = Depends(get_db))-> AdresseTypeBase:
