...
async def get_adresses_types(adresses_types_repository: AdresseTypesRepository = Depends(AdresseTypesRepository),db:AsyncSession = Depends(get_db))-> list[AdresseTypeBase]:
...
async def get_adresses_type_value(adresses_types: str, adresses_types_repository: AdresseTypesRepository = Depends(AdresseTypesRepository), db:AsyncSession = Depends(get_db)) -> AdresseTypeBase:
...
async def get_adresses_type_user(user_id: int, adresses_types_repository: AdresseTypesRepository = Depends(AdresseTypesRepository), db:AsyncSession = Depends(get_db)) -> AdresseTypeBase| list[AdresseTypeBase]:
...
async def update_adresse_type(adresses_type_id: int, adresse_type: AdresseTypeBase,adresses_type_repository: AdresseTypesRepository = Depends(AdresseTypesRepository), db:AsyncSession = Depends(get_db))-> AdresseTypeBase:
    updated_adresse_type = await adresses_type_repository.update_adressestypes(db, adresses_type_id, adresse_type)
