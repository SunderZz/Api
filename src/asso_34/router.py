...
async def get_asso_34oses(asso_34_repository: Asso_34Repository = Depends(Asso_34Repository), db:AsyncSession = Depends(get_db)) -> list[Asso_34Base]:
...
async def get_asso_34ose_by_id(asso_34_id: int, asso_34_repository: Asso_34Repository = Depends(Asso_34Repository), db:AsyncSession = Depends(get_db)) -> Asso_34Base:
...
async def create_asso_34(asso_34: Asso_34Base, asso_34_repository: Asso_34Repository = Depends(Asso_34Repository), db:AsyncSession = Depends(get_db)) -> Asso_34Base:
...
async def update_asso_34(asso_34_id: int, asso_34: Asso_34Base, asso_34_repository: Asso_34Repository = Depends(Asso_34Repository), db:AsyncSession = Depends(get_db)) -> Asso_34Base:
