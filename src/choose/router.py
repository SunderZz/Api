...
async def get_chooseoses(choose_repository: ChooseRepository = Depends(ChooseRepository), db: Session = Depends(get_db)) -> list[ChooseBase]:
...
async def get_chooseose_by_id(choose_id: int, choose_repository: ChooseRepository = Depends(ChooseRepository), db: Session = Depends(get_db)) -> ChooseBase:
...
async def create_choose(choose: ChooseBase, choose_repository: ChooseRepository = Depends(ChooseRepository), db: Session = Depends(get_db)) -> ChooseBase:
...
async def update_choose(choose_id: int, choose: ChooseBase, choose_repository: ChooseRepository = Depends(ChooseRepository), db: Session = Depends(get_db)) -> ChooseBase:
