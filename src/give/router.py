...
async def get_gives(give_repository: GiveRepository = Depends(GiveRepository), db:AsyncSession = Depends(get_db)) -> list[GiveBase]:
...
async def get_give_by_id(give_id: int, give_repository: GiveRepository = Depends(GiveRepository), db:AsyncSession = Depends(get_db)) -> GiveBase:
...
async def update_give(give_id: int, give: GiveCalcBase, give_repository: GiveRepository = Depends(GiveRepository), db:AsyncSession = Depends(get_db)) -> GiveBase:
