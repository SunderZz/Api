...
async def get_is_ons(is_on_repository: IsOnRepository = Depends(IsOnRepository), db:AsyncSession = Depends(get_db)) -> list[IsOnBase]:
...
async def get_is_on_by_id(is_on_id: int, is_on_repository: IsOnRepository = Depends(IsOnRepository), db:AsyncSession = Depends(get_db)) -> IsOnBase | list[IsOnBase]:
...
async def update_is_on(is_on_id: int, is_on: IsOnBase, is_on_repository: IsOnRepository = Depends(IsOnRepository), db:AsyncSession = Depends(get_db)) -> IsOnBase:
