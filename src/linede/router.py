...
async def create_linede_for_order(linede: LinedeBase |list[LinedeBase], linede_repository: LinedeRepository = Depends(LinedeRepository), db: Session = Depends(get_db)) -> LinedeBase | list[LinedeBase]:
