...
async def get_orderss(orders_repository: OrdersRepository = Depends(OrdersRepository),db:AsyncSession = Depends(get_db))-> list[OrdersBase]:
...
async def get_orders_value(id_orders: int, orders_repository: OrdersRepository = Depends(OrdersRepository), db:AsyncSession = Depends(get_db)) -> OrdersBase:
...
async def create_orders_from_user(orders: OrdersBase,orders_repository: OrdersRepository = Depends(OrdersRepository), db:AsyncSession = Depends(get_db))-> OrdersIdBase:
...
async def update_orders(orders_id: int, orders: OrdersBase,orders_repository: OrdersRepository = Depends(OrdersRepository), db:AsyncSession = Depends(get_db))-> OrdersBase:
...
async def create_orders_card(casual: OrdersBase,products:int | list[int], quantity:int | list[int],orders_repository: OrdersRepository = Depends(OrdersRepository),products_repository: ProductRepository = Depends(ProductRepository),linede_repository: LinedeRepository = Depends(LinedeRepository), db:AsyncSession = Depends(get_db))-> OrdersIdBase:
...
async def update_orders_card(order: int,products:int , quantity:int ,products_repository: ProductRepository = Depends(ProductRepository),linede_repository: LinedeRepository = Depends(LinedeRepository), db:AsyncSession = Depends(get_db))-> LinedeBase:
...
async def valid_orders_card(order:int,id_customers: int,give_repository: GiveRepository = Depends(GiveRepository),orders_repository: OrdersRepository = Depends(OrdersRepository),linede_repository: LinedeRepository = Depends(LinedeRepository), db:AsyncSession = Depends(get_db))-> OrdersBase | list[OrdersBase]:
