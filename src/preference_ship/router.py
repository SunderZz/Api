...
async def get_preferenceship(preferenceship: PreferenceshipBase,preferenceship_repository: PreferenceshipRepository = Depends(PreferenceshipRepository), db:AsyncSession = Depends(get_db))-> PreferenceshipBase:
...
async def update_preferenceship(preferenceship_id: int, preferenceship: PreferenceshipBase,product_repository: PreferenceshipRepository = Depends(PreferenceshipRepository), db:AsyncSession = Depends(get_db))-> PreferenceshipBase:
...
async def create_preference_ship(preference_ship: PreferenceshipBase,preference_ship_repository: PreferenceshipRepository = Depends(PreferenceshipRepository), db:AsyncSession = Depends(get_db))-> PreferenceshipIdBase:
