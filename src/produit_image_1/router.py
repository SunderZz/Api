...
async def get_produit_images(produit_image_repository: ProduitImageRepository = Depends(ProduitImageRepository),db: Session = Depends(get_db))-> list[ProduitImageBase]:
...
async def get_produit_image_value(produit_image: str, produit_image_repository: ProduitImageRepository = Depends(ProduitImageRepository), db: Session = Depends(get_db)) -> ProduitImageBase:
...
async def create_produit_image(produit_image: ProduitImageBase,produit_image_repository: ProduitImageRepository = Depends(ProduitImageRepository), db: Session = Depends(get_db))-> ProduitImageBase:
...
async def update_produit_image(produit_image_id: int, produit_image: ProduitImageBase,produit_image_repository: ProduitImageRepository = Depends(ProduitImageRepository), db: Session = Depends(get_db))-> ProduitImageBase:
