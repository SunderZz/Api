...
async def get_redacts_service(redact_repository: RedactRepository, db: AsyncSession) -> list[RedactBase]:
...
async def get_redact_value_service(admin_id: int, redact_id: int, redact_repository: RedactRepository, db: AsyncSession) -> RedactBase:
...
async def create_redact_service(admin_id: int, redact_id: int, redact: RedactBase, redact_repository: RedactRepository, db: AsyncSession) -> RedactBase:
...
async def update_redact_service(admin_id: int, recipe_id: int, redact: RedactBase, redact_repository: RedactRepository, db: AsyncSession) -> RedactBase:
